...
void blufi_dh_negotiate_data_handler(uint8_t* data, int len, uint8_t** output_data, int* output_len, bool* need_free) {
    ...
    switch (type) {
        ...
        case SEC_TYPE_DH_PARAM_DATA: {
            ...
            ret = mbedtls_dhm_calc_secret(&blufi_sec->dhm, blufi_sec->share_key, SHARE_KEY_BIT_LEN, &blufi_sec->share_len, myrand, NULL);
            if (ret) {
        ...
        case SEC_TYPE_DH_P: break;
        case SEC_TYPE_DH_G: break;
        case SEC_TYPE_DH_PUBLIC: break;
    }
}
